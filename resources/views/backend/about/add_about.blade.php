                    ...
                    <div class="col-md-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                ...
                                @endif
                                <h6 class="card-title">About Form</h6>

                                <form class="forms-sample" method="POST" action={{ route('store.about') }}
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="content" id="content" placeholder="Content" style="height: 100px; width:50%;"></textarea>
                                        <div class="text-danger form-control-feedback">
