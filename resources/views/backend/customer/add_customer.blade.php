                    ...
                    <div class="col-md-12 grid-margin">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('store.customer') }}" method="POST" class="forms-sample"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="phone_primary"
                                                    id="" placeholder="Example: 09123456789" required>
                                                <div class="text-danger form-control-feedback">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea name="address" id="address" class="form-control bg-dark" required>{{ old('address') }}</textarea>
                                                <div class="text-danger form-control-feedback">
